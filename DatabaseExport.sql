--------------------------------------------------------
--  File created - Tuesday-January-19-2021   
--------------------------------------------------------
--------------------------------------------------------
...
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (1,'David','Goricanec',to_date('23.07.96','DD.MM.RR'),46.8883,15.5132,'B9456FB90517E2C8E0538C10000A2414',to_date('20.01.21','DD.MM.RR'),'5.1@email.com','1234A',0);
