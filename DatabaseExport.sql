...
--------------------------------------------------------
  ...
  CREATE TABLE "BANDFINDER"."USERS" 
   (	"USR_ID" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"PHOTO" BLOB, 
	"PHOTONAME" VARCHAR2(50 CHAR) COLLATE "USING_NLS_COMP"
   )  DEFAULT COLLATION "USING_NLS_COMP" SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 10 MAXTRANS 255 
 COLUMN STORE COMPRESS FOR QUERY HIGH ROW LEVEL LOCKING LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
SET DEFINE OFF;
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHOTONAME) values (3,'TestFirstname','TestLastname',to_date('23.01.96','DD.MM.RR'),46.8282,15.2087,null,null,'1.1@email.com','1234','logo.png');
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHOTONAME) values (21,'Manuel','Mune',to_date('07.02.93','DD.MM.RR'),40.73061,-73.935242,null,null,'2.2@email.com','1234',null);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHOTONAME) values (22,'Danial','Hard',to_date('09.10.95','DD.MM.RR'),40.73061,-73.935242,null,null,'3.1@email.com','1234',null);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHOTONAME) values (23,'Michelle','Cloud',to_date('29.06.98','DD.MM.RR'),40.73061,-73.935242,null,null,'4.1@email.com','1234',null);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHOTONAME) values (1,'David','Goricanec',to_date('23.07.96','DD.MM.RR'),46.8883,15.5132,'B81CBF9BE031B703E0538D10000A28E4',to_date('05.01.21','DD.MM.RR'),'5.1@email.com','1234A','logo.png');
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHOTONAME) values (5,'Herbert','Mauer',to_date('05.12.90','DD.MM.RR'),47.0667,15.45,null,null,'6.1@email.com','1234',null);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHOTONAME) values (41,'PUT','TEST',to_date('01.11.80','DD.MM.RR'),1,1,'B80136AAE3E8723BE0538D10000AF4BD',to_date('04.01.21','DD.MM.RR'),'test@ff.cdd','1234',null);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHOTONAME) values (4,'Sabrina','Haidinger',to_date('23.04.97','DD.MM.RR'),46.9653,15.4803,null,null,'7.1@email.com','1234','logo.png');
