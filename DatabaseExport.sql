--------------------------------------------------------
--  File created - Sunday-January-24-2021   
--------------------------------------------------------
--------------------------------------------------------
...
Insert into BANDFINDER.MEDIA (MED_ID,USR_ID,TITLE,CONTENT_TYPE,IS_PROFILE_PICTURE) values (61,165,'test','image/jpeg','Y');
Insert into BANDFINDER.MEDIA (MED_ID,USR_ID,TITLE,CONTENT_TYPE,IS_PROFILE_PICTURE) values (63,166,'test','image/jpeg','Y');
Insert into BANDFINDER.MEDIA (MED_ID,USR_ID,TITLE,CONTENT_TYPE,IS_PROFILE_PICTURE) values (41,121,'test','image/jpeg','Y');
...
SET DEFINE OFF;
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (3,'TestFirstname','TestLastname',to_date('23.01.96','DD.MM.RR'),46.8282,15.2087,null,null,'1.1@email.com','1234',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (63,'Sangina','Haidinger',to_date('06.01.07','DD.MM.RR'),47.0886344,15.4161392,'B8430AE1D2C02279E0538D10000A95FF',to_date('07.01.21','DD.MM.RR'),'sangi@hub.com','1278',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (81,'d','d',to_date('30.12.20','DD.MM.RR'),48.108076999999994,15.804955800000002,'B8693FBECC1F710EE0538C10000A0D0A',to_date('09.01.21','DD.MM.RR'),'d@d.com','d',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (101,'Pic','Pic',to_date('14.01.21','DD.MM.RR'),46.8126665,15.2389207,'B86D7F37479C79D3E0538C10000A7B05',to_date('10.01.21','DD.MM.RR'),'pic.ht@dz.vh','1234',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (105,'H','I',to_date('22.01.21','DD.MM.RR'),46.8126171,15.2389104,'B86DB789866591D7E0538C10000A6FF2',to_date('10.01.21','DD.MM.RR'),'tu.hg@gh.com','23gg',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (113,'H','J',to_date('15.01.21','DD.MM.RR'),46.8126585,15.2389158,'B86DB789866691D7E0538C10000A6FF2',to_date('10.01.21','DD.MM.RR'),'fhu.vj@fz.com','256',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (114,'H','G',to_date('09.01.21','DD.MM.RR'),46.8126652,15.2389134,'B86DB789866791D7E0538C10000A6FF2',to_date('10.01.21','DD.MM.RR'),'h.b@gg.com','h',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (164,'Tgfjvfkncdjbcdj','SUPERLONGNAME',to_date('14.01.21','DD.MM.RR'),47.0886538,15.4160538,'B9A5D8B8E6B82F43E0538C10000A5AAE',to_date('25.01.21','DD.MM.RR'),'f.n@hhhhgh.com','12356434zztrrreeerttzhvgtz',2888);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (165,'Angelika','Ha',to_date('09.01.96','DD.MM.RR'),47.0886035,15.416153,'B9A64AC93C9B58A2E0538C10000AFA52',to_date('25.01.21','DD.MM.RR'),'angi@mail.com','1234',65548953);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (21,'Manuel','Mune',to_date('07.02.93','DD.MM.RR'),40.73061,-73.935242,null,null,'2.2@email.com','1234',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (22,'Danial','Hard',to_date('09.10.95','DD.MM.RR'),40.73061,-73.935242,null,null,'3.1@email.com','1234',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (23,'Michelle','Cloud',to_date('29.06.98','DD.MM.RR'),40.73061,-73.935242,'B86E5EE3821E3E22E0538C10000ACDB0',to_date('10.01.21','DD.MM.RR'),'4.1@email.com','1234',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (121,'Markus','Freund',to_date('04.01.21','DD.MM.RR'),47.0886583,15.4161042,'B8B59752173E4E9AE0538C10000ACEF3',to_date('13.01.21','DD.MM.RR'),'markus.Freund@aon.com','1235',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (62,'TestUser','LastName',to_date('27.01.21','DD.MM.RR'),47.0886596,15.415957400000002,'B84255778D153180E0538D10000A07F9',to_date('07.01.21','DD.MM.RR'),'sd@fw.com','1234',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (1,'David','Goricanec',to_date('23.07.96','DD.MM.RR'),46.8883,15.5132,'B9A50BDB20D3515FE0538C10000A46CB',to_date('25.01.21','DD.MM.RR'),'5.1@email.com','1234A',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (102,'D','D',to_date('15.01.21','DD.MM.RR'),46.8126208,15.238913,'B86D8EADEB63B804E0538C10000A1E96',to_date('10.01.21','DD.MM.RR'),'ft.j@j.com','45',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (5,'Herbert','Mauer',to_date('05.12.90','DD.MM.RR'),47.0667,15.45,null,null,'6.1@email.com','1234',66480935184);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (103,'4','6',to_date('21.01.21','DD.MM.RR'),46.8125953,15.2389299,'B86D8EADEB64B804E0538C10000A1E96',to_date('10.01.21','DD.MM.RR'),'gh6.jh@h.j.com','45z',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (106,'Pihh','Gjk',to_date('14.01.21','DD.MM.RR'),46.8126167,15.2389044,'B86DC47518198C26E0538C10000A9810',to_date('10.01.21','DD.MM.RR'),'gu.j@gj.com','236h',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (107,'D','H',to_date('13.01.21','DD.MM.RR'),46.8126152,15.2389053,'B86DC475181A8C26E0538C10000A9810',to_date('10.01.21','DD.MM.RR'),'hu.j@gz.com','134',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (108,'J','H',to_date('21.01.21','DD.MM.RR'),46.8126186,15.2388911,'B86DC475181B8C26E0538C10000A9810',to_date('10.01.21','DD.MM.RR'),'f.g@f.t.com','2',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (109,'d','d',to_date('30.12.20','DD.MM.RR'),48.108076999999994,15.804955800000002,'B86DC475181C8C26E0538C10000A9810',to_date('10.01.21','DD.MM.RR'),'d.fg@gmc.coom','3',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (111,'H','H',to_date('21.01.21','DD.MM.RR'),46.8126171,15.2389108,'B86DC475181D8C26E0538C10000A9810',to_date('10.01.21','DD.MM.RR'),'h.b gru@jj.com','46',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (115,'Hh','Vh',to_date('22.01.21','DD.MM.RR'),46.8126188,15.2389084,'B86E323BA5A2B4CFE0538C10000A7B8C',to_date('10.01.21','DD.MM.RR'),'gh.jj@zu.com','134',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (163,'T','H',to_date('14.01.21','DD.MM.RR'),47.0886257,15.4161068,'B9A5D486B7531F75E0538C10000ABACA',to_date('25.01.21','DD.MM.RR'),'f.n@gh.com','234',2888);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (82,'D','D',to_date('23.01.21','DD.MM.RR'),46.8129143,15.2386233,'B8696CBD961D6A38E0538C10000A63D3',to_date('09.01.21','DD.MM.RR'),'c.c@v.com','133',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (166,'Dave','Gor',to_date('20.01.21','DD.MM.RR'),47.0886356,15.4160844,'B9A61B0420899505E0538C10000A612C',to_date('25.01.21','DD.MM.RR'),'ft.gf@gu.com','1234',123456789);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (110,'r','r',to_date('24.01.21','DD.MM.RR'),46.8129254,15.238799400000001,'B86DF2EC136E1086E0538C10000A6707',to_date('10.01.21','DD.MM.RR'),'d.fg@gmc.coomrr','324',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (112,'G','H',to_date('22.01.21','DD.MM.RR'),46.8137465,15.2375282,'B86DF2EC136F1086E0538C10000A6707',to_date('10.01.21','DD.MM.RR'),'g.j@hj.com','34h',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (162,'PUT','TEST',to_date('01.11.80','DD.MM.RR'),1,1,'B9A59C98C3D3F600E0538C10000A8204',to_date('25.01.21','DD.MM.RR'),'tesdt@ff.cdddddd','1234',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (4,'Sabrina','Haidinger',to_date('23.04.97','DD.MM.RR'),46.9653,15.4803,null,null,'7.1@email.com','1234',69919267702);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (144,'PUT','TEST',to_date('01.11.80','DD.MM.RR'),1,1,'B940FBED7584C2FDE0538C10000ACC0A',to_date('20.01.21','DD.MM.RR'),'tesdt@ff.cddd','1234',0);
Insert into BANDFINDER.USERS (USR_ID,FIRSTNAME,LASTNAME,BIRTHDAY,LATITUDE,LONGITUDE,SESSION_KEY,SESSION_EXPIRE_DATE,EMAIL,PASSWORD,PHONENUMBER) values (141,'PUT','TEST',to_date('01.11.80','DD.MM.RR'),1,1,'B940E423819B4DB3E0538C10000AEEED',to_date('20.01.21','DD.MM.RR'),'tesdt@ff.cdd','1234',0);
...
Insert into BANDFINDER.USER_INSTRUMENTS (USR_INS_ID,USR_ID,INSTR_CODE,STARTED_PLAYING,PLAY_LEVEL) values (43,121,'DRM',to_date('01.01.21','DD.MM.RR'),30);
Insert into BANDFINDER.USER_INSTRUMENTS (USR_INS_ID,USR_ID,INSTR_CODE,STARTED_PLAYING,PLAY_LEVEL) values (69,166,'TRPT',to_date('24.01.15','DD.MM.RR'),30);
...
Insert into BANDFINDER.USER_INSTRUMENTS (USR_INS_ID,USR_ID,INSTR_CODE,STARTED_PLAYING,PLAY_LEVEL) values (61,165,'PNO',to_date('01.01.21','DD.MM.RR'),20);
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "BANDFINDER"."UPDATE_USER" (
    ...
    p_email      IN users.email%TYPE,
    p_phonenumber IN users.phonenumber%TYPE,
    p_session_key IN  users.session_key%TYPE
)IS
...
--------------------------------------------------------
  ...
  ALTER TABLE "BANDFINDER"."USERS" MODIFY ("PHONENUMBER" NOT NULL ENABLE);
